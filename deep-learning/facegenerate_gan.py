...
class FaceGenerator:
    ...
    def get_training_data(self,path):
        ...
        for directory in dir_list:
            ...
            for img in img_list:
                ...
                training_data.append(temp_img_array)
    ...
    def train(self,path,epochs,batch_size,save_images_interval):
        #Get the real images
        training_data = self.get_training_data(path)
...
if __name__ == '__main__':
    ...
    facegenerator.train(path='/home/takatom/GAN/thumbnails128x128/',epochs=4000, batch_size=32, save_images_interval=100)
    facegenerator.generate_single_image("gan.h5","test.png")
